...
class Operator {
    ...
    static var weightVec: [String:(String,Chunk,Double)] = [:]
    ...
    */
    ...
    var totalActivation = 0.0 // initialize edl-related total activation
    ...
    func updateOperatorSjis(_ payoff: Double) {
        ...
        for (operatorChunk,_,context) in previousOperators { //operatorTime
            ...
            let maxAssoc = operatorChunk.baseLevelActivationAlt()
